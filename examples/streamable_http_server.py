...
async def _create_streaming_response(message: Dict[str, Any], session: Dict[str, Any], response: Response):
...
"""
                ...
                return {
                    "jsonrpc": "2.0", "id": msg_id,
                    "result": {
                        "contents": [{"uri": uri, "mimeType": "text/plain", "text": comparison_text}]
                    }
                }
