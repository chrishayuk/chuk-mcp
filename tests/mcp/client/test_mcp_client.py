...
class TestMCPClient:
    ...
    async def test_initialize_success(self, mock_transport, mock_streams):
        ...
        with patch(
            ...
            _result = await client.initialize()
    ...
    async def test_read_resource(self, mock_transport, mock_streams):
        ...
        with patch(
            ...
            return_value=mock_resource_response,
        ) as mock_send:
...
class TestConnectToServer:
    ...
    async def test_connect_error_handling(self):
        ...
        with patch(
            "chuk_mcp.client.client.send_initialize",
            side_effect=Exception("Init failed"),
        ):
            with pytest.raises(Exception, match="Init failed"):
                async with connect_to_server(mock_transport) as _client:
                    pass
