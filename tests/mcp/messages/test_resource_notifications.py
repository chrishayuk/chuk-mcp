...
from chuk_mcp.protocol.messages.resources.notifications import (
...
async def test_handle_resources_list_changed_notification():
    ...
    notification = {"jsonrpc": "2.0", "method": "notifications/resources/list_changed"}
...
async def test_handle_resources_list_changed_notification_wrong_method():
    ...
    notification = {"jsonrpc": "2.0", "method": "some_other_notification"}
...
async def test_resources_notification_client_integration():
    ...
    resource_updated_notification = {
        "jsonrpc": "2.0",
        "method": "notifications/resources/updated",
        "params": {"uri": "file:///updated_file.txt"},
    }
    ...
    await handle_resources_list_changed_notification(
        on_list_changed, received_notification
    )

    received_notification = await read_receive.receive()
    await handle_resources_updated_notification(
        on_resource_updated, received_notification
    )
